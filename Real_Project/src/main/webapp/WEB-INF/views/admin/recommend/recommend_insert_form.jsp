...
<script type="text/javascript">
	...
	function send(f){
		...
		f.action = "admin/recommend_insert.do";	
		f.submit();
...
<div id="box">
      ...
      <div class="panel-heading"><h3>Recommend Insert</h3></div>
      	...
      	<table class="table table-striped">
      		...
      		<tr>
      			...
      			<td colspan="2" align="center">
      				...
      				<input class="btn btn-dark" type="button" value="취소" onclick="location.href='recommend_list.do';">
      			</td>
      		</tr>
      	</table>
      </div>
